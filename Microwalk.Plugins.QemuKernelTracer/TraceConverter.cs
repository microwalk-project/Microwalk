...
public class TraceConverter : TraceStage
{
    ...
    /// </summary>
    List<(ulong oldBaseAddress, ulong oldEndAddress, ulong offset)> _moduleSectionsTranslations = new();
    ...
    protected override Task InitAsync(YamlMappingNode? moduleOptions)
    {
        ...
        _translatedModuleBaseAddress = moduleOptions.GetChildNodeWithKey("kernel-module-translated-address")?.GetNodeUnsignedLongHex() ?? throw new ConfigurationException("Missing kernel module section translation base address.");
